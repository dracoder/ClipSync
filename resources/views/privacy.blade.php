...
@section('title', __('Privacy and Cookie Policy'))
@section('descrizioneSeo', __('Learn about how we manage your data by reading our privacy and cookie policy').".")
