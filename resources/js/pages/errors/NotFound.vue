<template>
    <main class="color-bg">
        <svg viewBox="0 0 541.17206 328.45184" height="250" width="541.17206" id="svg2" version="1.1"
        ...
        <p id="errorText" style="padding: 10px;text-align: center;">OPS!<br> The page you are looking for does not exist
            or has been moved.</p>
        <a id="errorLink" href="/" style="border-radius: 33px;">&larr; Go Back</a>
    </main>
</template>
<script setup>
</script>
